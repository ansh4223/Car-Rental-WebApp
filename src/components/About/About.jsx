    ...
    >
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 place-items-center">
          <div
          data-aos="slide-right" data-aos-duration="1500" data-aos-once="false">
            <img src={CarPng} alt="" 
          ...
          <div className="space-y-5 sm:p-16 pb-6">
            ...
            <p data-aos="fade-up">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil tempore atqueut doloremque est.
            </p>
            <p data-aos="fade-up">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil tempore atqueut doloremque est.
            </p>
